...
for i in range(len(my_gaf)):
    ...
    if len(reads_same_name) == 0:
        print("Couldn't find read {}, skipped".format(name))
        continue
    elif len(reads_same_name) > 1:
        print("Found multiple matching reads for {}, skipped".format(name))
        continue
    ...
    similarity_distribution.append({"name": name, "similarity": edit_similarity})
